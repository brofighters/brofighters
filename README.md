...
- **Special (Template Guy):** `block + back + jump` → Rising Fist (knockdown).
...
keyboard input for N players, a data-driven reference character (`Template Guy`)
with punch / 3-hit combo / special, menus, and round flow (health to
